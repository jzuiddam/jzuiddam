...
In LaTex hebben zijn een speciale betekenis. Van @{@, @}@ en @\@ hebben we al gezien wat de speciale betekenis is. Als je gereserveerde karakters in je tekst wilt gebruiken, dan moet je commando's gebruiken:
...
Een andere manier om speciale tekens te maken is door een commando toe te passen op een letter. We beginnen met accenten op tekens.
