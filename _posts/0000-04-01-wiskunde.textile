...
category: week1
description: Wiskundeomgeving, tekens, machten en indices, operatoren, breuken, wortels, puntjes, matrices, haakjes, tekst in wiskunde, horizontale witruimte, opmaak, lijst van symbolen.
---
...
Er zijn meer operatoren die op deze manier limieten zetten, zoals @\prod@ $\prod$ en @\bigcup@ $\bigcup$, zie het overzicht. Om meedere regels onder een som te zetten gebruik je @\substack@ en @\\@:
...
*Haakdjes* en andere *delimiters* zet je zo:
...
Tekst in _math mode_ zet je met @\text@. Je moet daarbij goed op de witruimte lettern. Hieronder zie je twee goede regels en een foute.
...
*Stelling 2* (Ongelijkheid van Cauchy-Schwarz) *.* Als $X$ en $Y$ stochastische grootheden zijn met $EX^2 \lt \infty$ en $EY^2 \lt \infty$, dan geldt
\[
