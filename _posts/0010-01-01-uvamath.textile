...
# Download de "uvamath class":https://github.com/jzuiddam/uvamath/archive/master.zip. Pak het zip-bestand uit.
...
#2 Open @verslag.tex@. Hierin schrijf je het verslag. We zien het volgende.

Het bestand begint met het laden van de @uvamath@ class en een aantal noodzakelijke packages.
...
Je kunt meerdere auteurs toevoegen door het commando @\author@ te herhalen. Als optioneel argument achter @\author@ geef je je emailadres en studentnummer.
